...
namespace NETworkManager.ViewModels
{
    public class PingHostViewModel : ViewModelBase
    {
        ...
        private void LoadSettings()
        {
            ...
            ProfileWidth = ExpandProfileView ? new GridLength(SettingsManager.Current.Ping_ProfileWidth) : new GridLength(GlobalStaticConfiguration.ProfileWidthCollapsed);
