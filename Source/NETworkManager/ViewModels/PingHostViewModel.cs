...
namespace NETworkManager.ViewModels
{
    public class PingHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        public PingHostViewModel(IDialogCoordinator instance)
        {
            ...
            InterTabClient = new DragablzInterTabClient(Models.Application.Name.Ping);

            TabItems = new ObservableCollection<DragablzTabItem>
            {
                new DragablzTabItem(Localization.Resources.Strings.NewTab, new PingView(_tabId), _tabId)
            };
        ...
        public void AddTab(string host = null)
        {
            ...
            TabItems.Add(new DragablzTabItem(host ?? Localization.Resources.Strings.NewTab, new PingView(_tabId, host), _tabId));
