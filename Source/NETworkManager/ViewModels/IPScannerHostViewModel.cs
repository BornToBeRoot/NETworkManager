...
namespace NETworkManager.ViewModels
{
    public class IPScannerHostViewModel : ViewModelBase
    {
        ...
        private void LoadSettings()
        {
            ...
            ProfileWidth = ExpandProfileView ? new GridLength(SettingsManager.Current.IPScanner_ProfileWidth) : new GridLength(GlobalStaticConfiguration.ProfileWidthCollapsed);
