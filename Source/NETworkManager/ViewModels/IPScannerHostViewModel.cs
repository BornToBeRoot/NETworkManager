...
namespace NETworkManager.ViewModels
{
    public class IPScannerHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        public IPScannerHostViewModel(IDialogCoordinator instance)
        {
            ...
            InterTabClient = new DragablzInterTabClient(Models.Application.Name.IPScanner);

            TabItems = new ObservableCollection<DragablzTabItem>
            {
                new DragablzTabItem(Localization.LanguageFiles.Strings.NewTab, new IPScannerView(_tabId), _tabId)
            };
        ...
        public void AddTab(string hostOrIPRange = null)
        {
            ...
            TabItems.Add(new DragablzTabItem(Localization.LanguageFiles.Strings.NewTab, new IPScannerView(_tabId, hostOrIPRange), _tabId));
