...
namespace NETworkManager.ViewModels.Dialogs
{
    public class WakeOnLANClientViewModel : ViewModelBase
    {
        ...
        {
            ProfileInfoChanged = (_clientInfo.Name != Name) || (_clientInfo.MACAddress != MACAddress) || (_clientInfo.Broadcast != Broadcast) || (_clientInfo.Port != Port) || (_clientInfo.Group != Group);
        }
    }
}