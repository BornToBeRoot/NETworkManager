...
namespace NETworkManager.ViewModels
{
    public class TracerouteHostViewModel : ViewModelBase
    {
        ...
        public TracerouteHostViewModel(IDialogCoordinator instance)
        {
            ...
            {
                new DragablzTracerouteTabItem(LocalizationManager.GetStringByKey("String_Header_Traceroute"), new TracerouteView(_tabId), _tabId)
            };
        ...
        private void AddTracerouteTab(string host = null)
        {
            ...
            TabItems.Add(new DragablzTracerouteTabItem(host ?? LocalizationManager.GetStringByKey("String_Header_Traceroute"), new TracerouteView(_tabId, host), _tabId));
