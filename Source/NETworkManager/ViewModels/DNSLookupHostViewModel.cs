...
namespace NETworkManager.ViewModels
{
    public class DNSLookupHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        public DNSLookupHostViewModel(IDialogCoordinator instance)
        {
            ...
            InterTabClient = new DragablzInterTabClient(Models.Application.Name.DNSLookup);

            TabItems = new ObservableCollection<DragablzTabItem>
            {
                new DragablzTabItem(Localization.LanguageFiles.Strings.NewTab, new DNSLookupView (_tabId), _tabId)
            };
        ...
        public void AddTab(string host = null)
        {
            ...
            TabItems.Add(new DragablzTabItem(host ?? Localization.LanguageFiles.Strings.NewTab, new DNSLookupView(_tabId, host), _tabId));
