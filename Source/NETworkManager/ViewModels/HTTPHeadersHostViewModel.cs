...
namespace NETworkManager.ViewModels
{
    public class HTTPHeadersHostViewModel : ViewModelBase
    {
        ...
        private void LoadSettings()
        {
            ...
            ProfileWidth = ExpandProfileView ? new GridLength(SettingsManager.Current.HTTPHeaders_ProfileWidth) : new GridLength(GlobalStaticConfiguration.ProfileWidthCollapsed);
