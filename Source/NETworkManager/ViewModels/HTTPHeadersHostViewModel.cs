...
namespace NETworkManager.ViewModels
{
    public class HTTPHeadersHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        public HTTPHeadersHostViewModel(IDialogCoordinator instance)
        {
            ...
            InterTabClient = new DragablzInterTabClient(Models.Application.Name.HTTPHeaders);

            TabItems = new ObservableCollection<DragablzTabItem>
            {
                new DragablzTabItem(Localization.LanguageFiles.Strings.NewTab, new HTTPHeadersView (_tabId), _tabId)
            };
        ...
        public void AddTab(string website = null)
        {
            ...
            TabItems.Add(new DragablzTabItem(website ?? Localization.LanguageFiles.Strings.NewTab, new HTTPHeadersView(_tabId, website), _tabId));
