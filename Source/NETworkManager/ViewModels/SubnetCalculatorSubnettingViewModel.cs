    ...
    public class SubnetCalculatorSubnettingViewModel : ViewModelBase
    {
        ...
        private async void Calculate()
        {
            ...
            if (65535 < Math.Pow(2, baseCidr - subnet.Cidr) / Math.Pow(2, (baseCidr - newCidr)))
            {
                ...
                if (await _dialogCoordinator.ShowMessageAsync(this, Localization.LanguageFiles.Strings.AreYouSure, Localization.LanguageFiles.Strings.TheProcessCanTakeUpSomeTimeAndResources, MessageDialogStyle.AffirmativeAndNegative, settings) != MessageDialogResult.Affirmative)
                {
