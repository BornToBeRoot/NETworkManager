...
namespace NETworkManager.ViewModels
{
    public class WhoisHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        public WhoisHostViewModel(IDialogCoordinator instance)
        {
            ...
            InterTabClient = new DragablzInterTabClient(Models.Application.Name.Whois);

            TabItems = new ObservableCollection<DragablzTabItem>
            {
                new DragablzTabItem(Localization.LanguageFiles.Strings.NewTab, new WhoisView (_tabId), _tabId)
            };
        ...
        private void AddTab(string domain = null)
        {
            ...
            TabItems.Add(new DragablzTabItem(domain ?? Localization.LanguageFiles.Strings.NewTab, new WhoisView(_tabId, domain), _tabId));
