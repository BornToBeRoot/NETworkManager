...
namespace NETworkManager.ViewModels
{
    public class WhoisHostViewModel : ViewModelBase
    {
        ...
        private void LoadSettings()
        {
            ...
            ProfileWidth = ExpandProfileView ? new GridLength(SettingsManager.Current.Whois_ProfileWidth) : new GridLength(GlobalStaticConfiguration.ProfileWidthCollapsed);
