...
namespace NETworkManager.ViewModels
{
    public class WhoisHostViewModel : ViewModelBase
    {
        ...
        public WhoisHostViewModel(IDialogCoordinator instance)
        {
            ...
            Profiles.Filter = o =>
            {
                ...
                if (search.StartsWith(TagIdentifier, StringComparison.OrdinalIgnoreCase))
                    return !string.IsNullOrEmpty(info.Tags) && info.HTTPHeaders_Enabled && info.Tags.Replace(" ", "").Split(';').Any(str => search.Substring(TagIdentifier.Length, search.Length - TagIdentifier.Length).Equals(str, StringComparison.OrdinalIgnoreCase));
        ...
        private void LoadSettings()
        {
            ...
            ProfileWidth = ExpandProfileView ? new GridLength(SettingsManager.Current.Whois_ProfileWidth) : new GridLength(40);
        ...
        public ICommand QueryProfileCommand
        {
            get { return new RelayCommand(p => QueryProfileAction()); }
        }
