...
namespace NETworkManager.Models.Documentation
{
    public static class LibraryManager
    {
        ...
        public static List<LibraryInfo> List => new List<LibraryInfo>
        {
            ...
            new LibraryInfo("CefSharp", "https://github.com/cefsharp/CefSharp",".NET (WPF and Windows Forms) bindings for the Chromium Embedded Framework ", "BSD-3-Clause", "https://github.com/cefsharp/CefSharp/blob/master/LICENSE" )
