        ...
        public static List<LibraryInfo> List
        {
            get
            {
                return new List<LibraryInfo>
                {
                    ...
                    new LibraryInfo("ControlzEx", "https://github.com/ControlzEx/ControlzEx", "Dragable and tearable tab control for WPF.", "MIT License", "https://github.com/ButchersBoy/Dragablz/blob/master/LICENSE"),
