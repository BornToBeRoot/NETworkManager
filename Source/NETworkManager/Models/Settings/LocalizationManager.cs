...
namespace NETworkManager.Models.Settings
{
    public static class LocalizationManager
    {
        public static List<LocalizationInfo> List => new List<LocalizationInfo>
        {
            ...
            new LocalizationInfo("Russian", "Русский", new Uri("/Resources/Localization/Flags/ru-RU.png", UriKind.Relative), "LaXe", "ru-RU", 91.97, true),
            ...
            new LocalizationInfo("Italian", "Italiano", new Uri("/Resources/Localization/Flags/it-IT.png", UriKind.Relative), "simone.ferrari", "it-IT", 99.05, false),
            new LocalizationInfo("Dutch", "Nederlands", new Uri("/Resources/Localization/Flags/nl-NL.png", UriKind.Relative), "Get_r3kt_by_Me", "nl-NL", 48.71, false),
            new LocalizationInfo("French", "Français", new Uri("/Resources/Localization/Flags/fr-FR.png", UriKind.Relative), "f4alm", "fr-FR", 16.46, false),            
            new LocalizationInfo("Chinese", "汉语", new Uri("/Resources/Localization/Flags/zh-CN.png", UriKind.Relative), "dockernes, Bonelol, ccstorm", "zh-CN", 31.84, false),
            /*
