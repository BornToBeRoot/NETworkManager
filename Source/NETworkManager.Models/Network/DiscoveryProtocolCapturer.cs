...
namespace NETworkManager.Models.Network
{
    public partial class DiscoveryProtocolCapturer
    {
        ...
        public DiscoveryProtocolCapturer()
        {
        ...
        #region Methods
        public void CaptureAsync(string netAdapter, int duration, DiscoveryProtocol protocol)
        {
            Task.Run(() =>
            {
                using (System.Management.Automation.PowerShell powerShell = System.Management.Automation.PowerShell.Create())
                {
                    ...
                    powerShell.AddScript($"Invoke-DiscoveryProtocolCapture -NetAdapter \"{netAdapter}\" -Duration {duration}" + (protocol != DiscoveryProtocol.LLDP_CDP ? $" -Type {protocol.ToString()}" : "") + "| Get-DiscoveryProtocolData");
