...
Install NETworkManager via Chocolatey:
...
Install NETworkManager via WinGet:
...
Get the latest NETworkManager release via Evergreen:
...
Install NETworkManager silent with the following command:
