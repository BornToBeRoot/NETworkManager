...
- A success message is now shown in the status bar after **Flush DNS cache**, **Release & Renew**, **Apply**, **Add IPv4 address**, and **Remove IPv4 address** complete successfully. [#XXXX](https://github.com/BornToBeRoot/NETworkManager/pull/XXXX)
- **Flush DNS cache** and **Release & Renew** buttons have been moved from the **Information** tab to the **Configure** tab, as they also require elevated rights. [#XXXX](https://github.com/BornToBeRoot/NETworkManager/pull/XXXX)
