---
sidebar_position: 0
description: "NETworkManager is a powerful open-source tool for managing networks and troubleshooting network problems on Windows. Features 25+ built-in tools including IP Scanner, Port Scanner, Remote Desktop, PowerShell, PuTTY (SSH), and more."
