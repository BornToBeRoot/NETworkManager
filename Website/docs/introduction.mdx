---
sidebar_position: 0
description: "NETworkManager — a free, open-source Windows tool with 25+ built-in network tools including IP Scanner, Port Scanner, Remote Desktop, PowerShell, and PuTTY."
